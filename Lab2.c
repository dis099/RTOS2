...
int main_step1(void){
//int main(void){
  OS_InitSemaphore(&s1,0);  //EDN: used for synchronization
  OS_InitSemaphore(&s2,1);  //EDN: used for mutex
  while(1){
...
// Use this as a simple main program to test the mailbox functions.
uint32_t Out;
